                ...
                <div className="flex gap-2">
                    <label htmlFor="image1">
                        <img
                            ...
                            src={!image1 ? (prevImages[0] ? prevImages[0] : assets.upload_area) : URL.createObjectURL(image1)}
                            alt="Upload Images"
                        />
                        <input
                    ...
                    <label htmlFor="image2">
                        <img
                            className="w-20 border-2 border-gray-500 rounded-lg cursor-pointer"
                            src={!image2 ? (prevImages[1] ? prevImages[1] : assets.upload_area) : URL.createObjectURL(image2)}
                            alt="Upload Images"
                        />
                        <input
                    ...
                    <label htmlFor="image3">
                        <img
                            className="w-20 border-2 border-gray-500 rounded-lg cursor-pointer"
                            src={!image3 ? (prevImages[2] ? prevImages[2] : assets.upload_area) : URL.createObjectURL(image3)}
                            alt="Upload Images"
                        />
                        <input
                    ...
                    <label htmlFor="image4">
                        <img
                            className="w-20 border-2 border-gray-500 rounded-lg cursor-pointer"
                            src={!image4 ? (prevImages[3] ? prevImages[3] : assets.upload_area) : URL.createObjectURL(image4)}
                            alt="Upload Images"
                        />
                        <input
